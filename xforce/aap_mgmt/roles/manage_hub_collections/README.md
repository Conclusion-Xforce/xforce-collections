...
remote definitions of collection repositories as defined in the hub_remote_repos variable. It is up to
...
- hub_remote_repos: List of dictionaries holding remote sources for repositories
