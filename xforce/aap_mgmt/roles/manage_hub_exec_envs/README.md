xforce.hub_tools.configure_hub_execenvs
=========

Role to perform the execution environment on Ansible Private Automation Hub configuration.
...
- hub_control_plane_ee: Namespace/image name of the control plane execution environment
